...
async function seed() {
      ...
      content: {
        items: [
          ...
          },
          {
            id: crypto.randomUUID(),
            name: '示例开源组件库 · FakeUI',
            url: 'https://github.com/example/fake-ui',
            startDate: '2023-03',
            endDate: '',
            description: '这是一个示例组件库项目描述，用于展示多个项目经历的排版效果。',
            technologies: ['React', 'TypeScript', 'Storybook', '示例技术'],
            highlights: [
              'GitHub X Stars，npm 周下载量 Y',
              '完善的某某支持，符合某某标准',
            ],
          },
        ],
  ...
  console.log('Seed complete! Demo resume created for user "amadeus"');
  process.exit(0);
}
